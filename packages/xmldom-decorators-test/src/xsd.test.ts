import { SchemaMapper } from '@neumaennl/xmldom-decorators-cli/lib/schemascanner';
import { Schema, Element, ComplexType, ComplexContent, ComplexContentExtension, Sequence } from '@neumaennl/xmldom-decorators-cli/lib/xsdschema';
